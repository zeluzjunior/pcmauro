...
SECRET_KEY = 'django-insecure-e0kk5cj0!4oz42e#f!o5%8lo6(+g_)5*si8i-q_x$-7mnz0$1f'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            # Avoid transient "database is locked" during large imports.
            'timeout': 30,
        },
    }
}
...
DEFAULT_FROM_EMAIL = 'noreply@meuprojeto.com'
