...
urlpatterns = [
    ...
    path('consultar/requisicoes-almoxarifado/visualizar/<int:requisicao_id>/', views.visualizar_requisicao_almoxarifado, name="visualizar_requisicao_almoxarifado"),
    ...
    path('consultar/paradas-de-maquina/visualizar/<int:parada_id>/', views.visualizar_parada_de_maquina, name="visualizar_parada_de_maquina"),
    path('producao-diaria/dados/', views.dados_producao_diaria, name="dados_producao_diaria"),
    path('producao-diaria/consultar/', views.consultar_producao_diaria, name="consultar_producao_diaria"),
    path('paradas-maquina/analise/', views.analise_paradas_maquina, name="analise_paradas_maquina"),
    path('paradas-maquina/analise-frigorifico/', views.analise_parada_frigorifico, name="analise_parada_frigorifico"),
    path('paradas-maquina/analise-industria/', views.analise_parada_industria, name="analise_parada_industria"),
    path('paradas-maquina/analise-maquina-por-parada/', views.analise_maquina_por_parada, name="analise_maquina_por_parada"),
    ...
    path('orcamento/visualizar-planilha-rc/<str:controle_id>/', views.visualizar_planilha_rc, name="visualizar_planilha_rc"),
    path('orcamento/analise-planilha-rc/', views.analise_planilha_rc, name="analise_planilha_rc"),
    path('orcamento/visualizar-relacao-projecao-nota/', views.visualizar_relacao_projecao_nota, name="visualizar_relacao_projecao_nota"),
