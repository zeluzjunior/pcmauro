...
urlpatterns = [
    ...
    path('importar/percentual-de-horas/', views.importar_percentual_de_horas, name="importar_percentual_de_horas"),
    path('importar/funcionario-manutencao/', views.importar_funcionario_manutencao, name="importar_funcionario_manutencao"),
    path('funcionario-manutencao/consultar/', views.consultar_funcionario_manutencao, name="consultar_funcionario_manutencao"),
    path('manutentor/analise-percentual-de-horas/', views.analise_percentual_de_horas, name="analise_percentual_de_horas"),
    ...
    path('importar/plano-lubrificacao/', views.importar_plano_lubrificacao, name="importar_plano_lubrificacao"),
    ...
    path('importar/requisicoes-por-os-manf0044/', views.importar_requisicao_por_os_manf0044, name="importar_requisicao_por_os_manf0044"),
    ...
    path('indicadores/digitar/', views.digitar_indicador, name="digitar_indicador"),
    path('indicadores/configuracoes/', views.configuracoes_indicadores, name="configuracoes_indicadores"),
    path('indicadores/analise/', views.analise_indicadores, name="analise_indicadores"),
    ...
    path('orcamento/visualizar-projecao-gasto/<str:projecao_id>/', views.visualizar_projecao_gasto, name="visualizar_projecao_gasto"),
    ...
    path('orcamento/ajuste-planilha-prejecao-gastos/', views.ajuste_planilha_prejecao_gastos, name="ajuste_planilha_prejecao_gastos"),
    ...
    path('orcamento/analise-controle-rc-notas/', views.analise_controle_rc_notas, name="analise_controle_rc_notas"),
    ...
    path('lubrificacao/analise-por-maquina/', views.analise_lubrificacao_por_maquina, name="analise_lubrificacao_por_maquina"),
